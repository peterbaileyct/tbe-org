...
* posts
  Contains an XML file exported from WordPress with all historical content of this paper. The author of each post can be most accurately identified via the content of the wp:author_display_name tag.